...
public:
    ...
    // 描述：获取指定设备的原始 D3D11 纹理对象（用于UE共享）
    // 参数：
    //   deviceID - 设备 ID
    // 返回值：
    //   ID3D11Texture2D 指针（如果不存在则返回 nullptr）
    //==========================================================================
    ID3D11Texture2D* GetLaserTextureRaw(int deviceID);

    //==========================================================================
    // 函数：GetSharedTextureHandle
    // 描述：获取指定设备纹理的共享句柄（用于跨设备/进程共享）
    // 参数：
    //   deviceID - 设备 ID
    // 返回值：
    //   共享句柄 HANDLE（如果失败则返回 nullptr）
    //==========================================================================
    HANDLE GetSharedTextureHandle(int deviceID);
